...
<nav class="col-lg-3 col-xl-9">
  <h2 class="offset-lg-2 col-lg-11 text-left offset-xl-1 col-xl-11">发布友情转让</h2>
</nav>
<hr>
<div class="container">
  ...
  <tbody>
    <tr>
      <td width="300px" valign="top"><img id="imgs1" src="ps4_image/gtav.jpeg" width="200" alt=""/></td>
      <td >
		  <form action=" ">
		  <p>请选择游戏：</p><select id="ps4Name" name="ps4Name" width="300px" class="form-control" onchange="test1(this)">
		  <%=giveResult%>
		  </select>
<input type="text" name="ps4_Name" id="ps4_Name" value="Grand Theft Auto V 侠盗猎车手 5" style="display:none">
        
			  <br><p>留言：</p>
			  <textarea name="words" class="form-control" style="height:100px"></textarea><br>
