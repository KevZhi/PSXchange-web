...
<nav class="col-lg-3 col-xl-9">
  <h2 class="offset-lg-2 col-lg-11 text-left offset-xl-1 col-xl-11">发布新二手</h2>
</nav>
<hr><div class="container">
    <table width="80%" border="0" cellspacing="30" cellpadding="30">
  <tbody>
    <tr>
      <td width="300px" valign="top"> <img id="imgs" src="ps4_image/gtav.jpeg" alt=""/></td>
      <td >
		  <form action=" ">
		  <p>请选择游戏：</p>
        ...
        <br>
		   <p>售价：（人民币）</p>
       <input name="price" type='text' onkeyup="this.value=this.value.replace(/\D|^0/g,'')" onafterpaste="this.value=this.value.replace(/\D|^0/g,'')" class="form-control" maxlength="3" required>
			<br><p>物品描述：</p>
			  <textarea name="words" class="form-control" style="height:100px" required></textarea><br><br>
